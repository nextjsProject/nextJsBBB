...
export default function impressum() {
  return (
    <Layout title="Impressum / Datenschutz">
      <h2 className="header-main">Angaben gem&auml;&szlig; &sect; 5 TMG:</h2>
      ...
      <div className="dasch">
        ...
        <p>
          ...
          pr&uuml;fen, wenn uns konkrete Anhaltspunkte f&uuml;r eine
        ...
        <p>
          ...
          Versand der angeforderten Informationen und geben sie nicht an Dritte
          weiter.
        </p>
        <p>
          Die erteilte Einwilligung zur Speicherung der Daten, der
          E-Mail-Adresse sowie deren Nutzung zum Versand des Newsletters
          k&ouml;nnen Sie jederzeit widerrufen, etwa &uuml;ber den
          &lsqo;Austragen&rsqo;-Link im Newsletter.
        </p>
        <p>&nbsp;</p>
        <h2>
        ...
        <p>
          ...
          Analyse der Benutzung der Website durch Sie erm&ouml;glichen. Die
          durch den Cookie erzeugten Informationen &uuml;ber Ihre Benutzung
        ...
        <p>
          ...
          nutzen k&ouml;nnen. Sie k&ouml;nnen dar&uuml;ber hinaus die Erfassung
          der durch den Cookie erzeugten und auf Ihre Nutzung der Website
        ...
        <p>
          ...
          werden. Dazu k&ouml;nnen Cookies eingesetzt werden. Bei Cookies
          handelt es sich um kleine Textdateien, die lokal im Zwischenspeicher
          Ihres Internet-Browsers gespeichert werden. Die Cookies
          erm&ouml;glichen es, Ihren Browser wieder zu erkennen. Die mit den
          etracker-Technologien erhobenen Daten werden ohne die gesondert
          erteilte Zustimmung des Betroffenen nicht genutzt, Besucher unserer
          Website pers&ouml;nlich zu identifizieren und werden nicht mit
          personenbezogenen Daten &uuml;ber den Tr&auml;ger des Pseudonyms
          zusammengef&uuml;hrt.
        </p>
        <p>
          Der Datenerhebung und -speicherung k&ouml;nnen Sie jederzeit mit
          Wirkung f&uuml;r die Zukunft widersprechen. Um einer Datenerhebung und
          -speicherung Ihrer Besucherdaten f&uuml;r die Zukunft zu
          widersprechen, k&ouml;nnen Sie unter nachfolgendem Link ein
          Opt-Out-Cookie von etracker beziehen, dieser bewirkt, dass
          zuk&uuml;nftig keine Besucherdaten Ihres Browsers bei etracker erhoben
        ...
        <p>
          Dadurch wird ein Opt-Out-Cookie mit dem Namen &lsqo;cntcookie&rsqo;
          von etracker gesetzt. Bitte l&ouml;schen Sie diesen Cookie nicht,
          solange Sie Ihren Widerspruch aufrecht erhalten m&ouml;chten. Weitere
        ...
        <p>
          ...
          verwendet so genannte &lsqo;Cookies&rsqo;. Das sind Textdateien, die
          auf Ihrem Computer gespeichert werden und die eine Analyse der
          Benutzung der Website durch Sie erm&ouml;glichen. Dazu werden die
          durch den Cookie erzeugten Informationen &uuml;ber die Benutzung
          dieser Website auf unserem Server gespeichert. Die IP-Adresse wird vor
          der Speicherung anonymisiert.
        </p>
        <p>
          Die durch den Cookie erzeugten Informationen &uuml;ber die Benutzung
          dieser Website werden nicht an Dritte weitergegeben. Sie k&ouml;nnen
          ...
          Sie in diesem Fall gegebenenfalls nicht s&auml;mtliche Funktionen
          dieser Website vollumf&auml;nglich werden nutzen k&ouml;nnen.
        </p>
        <p>
          Wenn Sie mit der Speicherung und Nutzung Ihrer Daten nicht
          einverstanden sind, k&ouml;nnen Sie die Speicherung und Nutzung hier
          deaktivieren. In diesem Fall wird in Ihrem Browser ein Opt-Out-Cookie
          hinterlegt der verhindert, dass Piwik Nutzungsdaten speichert. Wenn
          Sie Ihre Cookies l&ouml;schen hat dies zur Folge, dass auch das Piwik
          Opt-Out-Cookie gel&ouml;scht wird. Das Opt-Out muss bei einem erneuten
        ...
        <p>
          ...
          USA, integriert. Die Facebook-Plugins erkennen Sie an dem Facebook-
          Logo oder dem &lsqo;Like-Button&rsqo; (&lsqo;Gef&auml;llt mir&rsqo;)
        ...
        <p>
          Wenn Sie unsere Seiten besuchen, wird &uuml;ber das Plugin eine
          ...
          Account eingeloggt sind, k&ouml;nnen Sie die Inhalte unserer Seiten
        ...
        <p>
          ...
          von Twitter und der Funktion &lsqo;Re-Tweet&rsqo; werden die von Ihnen
          besuchten Webseiten mit Ihrem Twitter-Account verkn&uuml;pft und
        ...
        <p>
          ...
          k&ouml;nnen als Hinweise zusammen mit Ihrem Profilnamen und Ihrem Foto
        ...
        <p>
          ...
          als Anbieter der Seiten keine Kenntnis vom Inhalt der u?bermittelten
        ...
        <p>
          ...
          aufbaut. LinkedIn wird dar&uuml;ber informiert, dass Sie unsere
          Internetseiten mit Ihrer IP-Adresse besucht haben. Wenn Sie den
          &lsqo;Recommend-Button&rsqo; von LinkedIn anklicken und in Ihrem
        ...
        <p>
          ...
          Pinterest, das von der Pinterest Inc., 808 Brannan Street San
          Francisco, CA 94103-490, USA (&lsqo;Pinterest&rsqo;) betrieben wird.
          ...
          Pinterest her. Das Plugin &uuml;bermittelt dabei Protokolldaten an den
        ...
        <p>
          Auf unseren Seiten k&ouml;nnen Plugins des sozialen Netzwerks
        ...
        <p>
          ...
          den Besuch unserer Seiten zuordnen. Wir weisen darauf hin, dass wir
        ...
        <p>
          Wenn Sie nicht w&uuml;nschen, dass Soundcloud den Besuch unserer
          Seiten Ihrem SoundCloud- Benutzerkonto zuordnet, loggen Sie sich bitte
        ...
        <p>
          ...
          jedem Abruf einer unserer Seiten, die Funktionen von XING
          enth&auml;lt, wird eine Verbindung zu Servern von XING hergestellt.
        ...
        <p>
          ...
          folgen. Wenn Sie eine unserer Webseiten mit Tumblr-Button aufrufen,
        ...
        <p>
          ...
          YouTube-Plugin ausgestatteten Seiten besuchen, wird eine Verbindung zu
          den Servern von YouTube hergestellt. Dabei wird dem Youtube-Server
        ...
        <p>
          ...
          und, wenn Sie nicht anonym posten, der von Ihnen gew&auml;hlte
        ...
        <p>
          ...
          der Freischaltung pr&uuml;fen, ben&ouml;tigen wir diese Daten, um im
        ...
        <p>
          ...
          abonnieren. Sie erhalten eine Best&auml;tigungsemail, um zu
          pr&uuml;fen, ob Sie der Inhaber der angegebenen E-Mail-Adresse sind.
          Sie k&ouml;nnen diese Funktion jederzeit &uuml;ber einen Link in den
        ...
        <p>
          ...
          Berichtigung, Sperrung oder L&ouml;schung dieser Daten. Hierzu sowie
